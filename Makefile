...
help:
	...
	@echo "  emit-pins              re-record those verdicts (deliberate act, read _verify/verify_pins.py first)"
...
audit-repo:
	...
	@python3 _verify/scan_repo.py "$(REPO)" --out "$(or $(OUT),./audit-workspace)"
...
refresh:
	...
	@python3 _verify/extract_reference.py
