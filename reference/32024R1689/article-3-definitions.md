...
*Why this definition is here: ‘AI system’ — the gateway term for every obligation.*
...
*Why this definition is here: ‘provider’ — bears 50(1) and 50(2).*

(3) ‘provider’ means a natural or legal person, public authority, agency or other body that develops an AI system or a general-purpose AI model or that has an AI system or a general-purpose AI model developed and places it on the market or puts the AI system into service under its own name or trademark, whether for payment or free of charge;

*Why this definition is here: ‘deployer’ — bears 50(3) and 50(4).*
...
*Why this definition is here: ‘placing on the market’ — triggers the Art. 111(4) transitional window.*
...
*Why this definition is here: ‘putting into service’.*
...
*Why this definition is here: ‘emotion recognition system’ — trigger for 50(3).*
...
*Why this definition is here: ‘biometric categorisation system’ — trigger for 50(3).*
...
*Why this definition is here: ‘deep fake’ — trigger for 50(4) first subparagraph.*
...
*Why this definition is here: ‘general-purpose AI model’.*
...
*Why this definition is here: ‘general-purpose AI system’ — named expressly in 50(2).*
